...
( 'Pastries', 'Baked goods and desserts', NULL, GETDATE(), GETDATE()),
( 'Sandwiches', 'Savory and fresh sandwiches', NULL, GETDATE(), GETDATE());
GO
...
('Cappuccino', 'Foamy and delicious', 3.00, 1, 'https://example.com/cappuccino.jpg', 'Medium', 'Caramel', GETDATE(), GETDATE()),
( 'Green Tea', 'Refreshing green tea', 2.00, 2, 'https://example.com/greentea.jpg', 'Large', NULL, GETDATE(), GETDATE()),
( 'Blueberry Muffin', 'Soft and sweet muffin', 1.50, 3, 'https://example.com/muffin.jpg', NULL, NULL, GETDATE(), GETDATE());
GO
